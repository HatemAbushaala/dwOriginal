...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__configconstants___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__configconstants__);
// (C) Copyright 2015 Martin Dougiamas
//
// Licensed under the Apache License, Version 2.0 (the "License");
// you may not use this file except in compliance with the License.
...
var CoreSettingsAboutPage = /** @class */ (function () {
    function CoreSettingsAboutPage(platform, device, appProvider, fileProvider, initDelegate, langProvider, sitesProvider, localNotificationsProvider) {
        ...
        this.appName = appProvider.isDesktop() ? __WEBPACK_IMPORTED_MODULE_9__configconstants__["CoreConfigConstants"].desktopappname : __WEBPACK_IMPORTED_MODULE_9__configconstants__["CoreConfigConstants"].appname;
        this.versionName = __WEBPACK_IMPORTED_MODULE_9__configconstants__["CoreConfigConstants"].versionname;
        this.versionCode = __WEBPACK_IMPORTED_MODULE_9__configconstants__["CoreConfigConstants"].versioncode;
        this.compilationTime = __WEBPACK_IMPORTED_MODULE_9__configconstants__["CoreConfigConstants"].compilationtime;
        // Calculate the privacy policy to use.
        this.privacyPolicy = currentSite.getStoredConfig('tool_mobile_apppolicy') || currentSite.getStoredConfig('sitepolicy') ||
            __WEBPACK_IMPORTED_MODULE_9__configconstants__["CoreConfigConstants"].privacypolicy;
